...
const axes = [
  ...
  },
  {
    ...
    desc: 'Claude Cowork est intégré dans vos 3 process les plus chronophages.',
  },
  {
...
const Hero = () => {
  return (
    <section className="bg-gray dark:bg-dark relative overflow-hidden pt-[140px] pb-25 max-lg:pt-[120px] max-lg:pb-15">
      <div className="bg-primary/10 absolute -top-40 left-1/2 -z-10 h-[600px] w-[1100px] -translate-x-1/2 rounded-full blur-[120px]" />
      <div className="container">
        <div className="grid grid-cols-12 items-center gap-x-12 gap-y-12 lg:gap-x-16">
          <FadeUpAnimation className="col-span-12 space-y-6 lg:col-span-7 lg:space-y-8">
            <span className="border-borderColour text-paragraph dark:bg-dark-200/60 inline-flex items-center gap-2 rounded-full border bg-white/60 px-4 py-1.5 text-sm font-medium backdrop-blur dark:border-[#31332F] dark:text-white"></span>
            <h1 className="text-[40px]! leading-[1.15]! tracking-tight md:text-[44px]! xl:text-[52px]!">
              ...
              <span className="text-primary">Claude Cowork</span>
            </h1>
              ...
              <ul className="space-y-5">
                {axes.map((axe, i) => (
                  <li key={axe.title} className="flex items-start gap-4">
                    <span className="bg-primary/10 text-primary mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-sm font-semibold">
