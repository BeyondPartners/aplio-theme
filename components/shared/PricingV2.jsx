...
const PricingV2 = ({
  ...
  return (
    <section className={cn('dark:bg-dark-300 relative -z-0 overflow-hidden bg-white', className)}>
      <div className="container">
        <div className={`${largeTitle ? 'max-w-[900px]' : ''} relative z-100 mx-auto mb-12 text-center`}>
