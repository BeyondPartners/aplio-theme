  ...
  return (
    <section className="relative">
      ...
      <div className="relative container">
        ...
        <div className="relative mx-auto max-md:mt-20 max-md:mb-20 max-md:h-[220px] max-md:w-full md:mt-25 md:mb-32 md:max-w-[650px] lg:max-w-[750px] xl:max-w-[1020px]">
          <Image src={bannerLight} alt="about images" className="w-full max-md:h-full dark:hidden" />
          ...
          <FadeUpAnimation className="absolute top-10 -left-5 mx-auto aspect-auto w-150 sm:-left-15 sm:w-[250px] lg:-left-150 lg:w-[300px] xl:w-[380px]">
