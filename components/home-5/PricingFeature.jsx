              ...
              <div key={index}>
                {price.featured ? (
                  <div className="rounded-medium shadow-box dark:bg-dark-200 bg-white p-2.5">
                    <div className="rounded border border-dashed border-gray-100 p-8 lg:px-8 lg:pt-3 lg:pb-15 dark:border-gray-600">
                  ...
                  <div className="rounded-medium shadow-box dark:bg-dark-200 bg-white p-2.5">
                    <div className="rounded border border-dashed border-gray-100 p-8 dark:border-gray-600">
                      <h3 className="mb-2">{price.title}</h3>
                      <p className="mb-6">{price.desc}</p>
                      {isAnnual ? (
                        <div className="price-month mb-16">
