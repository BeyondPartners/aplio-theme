      ...
      <div className="container">
        ...
        <div className="relative z-20">
          ...
          <div className="rounded-medium shadow-box dark:bg-dark-200 bg-white p-2.5">
            <div className="border-opacity-10 grid h-full grid-cols-2 rounded border border-dashed border-gray-100 p-10 max-lg:p-5 max-md:grid-cols-1 dark:border-gray-600">
                  ...
                  <div className="flex gap-8 max-lg:flex-col">
                    <div className="w-full">
                      <input
                        ...
                        id="username"
                        placeholder="Name"
                        className="text-paragraph-light placeholder:text-paragraph-light focus:border-primary dark:bg-dark-200 dark:placeholder:text-paragraph-light dark:focus:border-primary mb-2.5 block h-[50px] w-full rounded-[48px] border border-gray-200 bg-white px-5 py-2.5 text-sm transition-all duration-300 outline-none dark:border-[#31332F]"
                      />
