          ...
          <div className="grid grid-cols-3 gap-8 max-md:grid-cols-1">
            {StepsData?.map((items, i) => (
              <FadeUpOneByOneAnimation
                ...
                <div className="h-full rounded border border-dashed border-gray-100 p-10 text-center max-lg:p-5 dark:border-gray-600">
                  <div className="bg-primary shadow-box dark:bg-primary/5 mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full">
                    <div className="flex h-15 w-15 items-center justify-center rounded-full border border-dashed border-white dark:border-gray-600">
