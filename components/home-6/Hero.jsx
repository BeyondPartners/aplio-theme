...
const Hero = () => {
  ...
  return (
    <section className="hero dark:bg-dark-300 relative bg-white pt-[230px] pb-[140px] max-lg:pt-[160px] max-lg:pb-25 max-md:pb-[70px]">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-5">
            ...
            <form>
              <div className="border-borderColour focus-within:border-primary dark:bg-dark-200 dark:focus-within:border-primary grid w-full max-w-[520px] grid-cols-12 items-center rounded-[60px] border bg-white pe-1 pt-1 pb-1 pl-4 transition-all duration-300 sm:pl-5 dark:border-[#31332F]">
                ...
                />
                <button className="btn max-1xl:!px-3 max-1xl:!text-sm xs:col-span-4 col-span-4">Get Started</button>
              </div>
            </form>
          </div>
            ...
            <div className="align-center relative flex justify-center">
              <div>
                <div className="absolute top-1/2 left-1/2 -z-10 flex w-full -translate-x-1/2 -translate-y-1/2 max-md:flex-col">
                  <div className="bg-primary-200/25 h-[502px] w-full rounded-full blur-[145px]"></div>
                </div>
                <div className="relative h-[566px] w-[296px] md:h-[375px] md:w-[200px] lg:h-[566px] lg:w-[296px]">
                  ...
                  <motion.div
                    ...
                    className="max-1xl:left-[-120px] max-1xl:h-[300px] max-1xl:w-[300px] max-xs:left-[-30px] max-xs:top-[230px] absolute top-[170px] left-[-220px] max-lg:top-[90px] max-lg:-left-25 max-lg:w-[200px] max-md:top-[170px] max-md:h-auto max-md:w-auto">
                  ...
                  <motion.div
                    ...
                    animate={controlAnimation}
                    variants={fadeUpAnimationDelay}
                    className="max-1xl:w-[220px] max-xs:right-[-40px] absolute top-[150px] right-[-100px] max-lg:top-[90px] max-lg:w-[180px] max-md:top-[150px] max-md:h-auto max-md:w-auto">
