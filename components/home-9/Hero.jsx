          ...
          <div className="container">
            <FadeUpAnimation className="pt-[140px] pb-[50px] text-center max-lg:pb-20 sm:pt-[170px] md:pb-20 lg:pt-44 lg:pb-25">
              ...
              <div className="hero-form relative z-20 mx-auto flex w-[90%] items-center justify-center md:w-auto">
                <form>
                  <div className="dark:bg-dark-200 focus-within:border-primary dark:focus-within:border-primary grid w-full max-w-[520px] grid-cols-12 items-center rounded-[60px] border border-gray-200 bg-white pe-1 pt-1 pb-1 pl-4 transition-all duration-300 sm:pl-5 dark:border-[#31332F]">
                    <input
                      type="text"
