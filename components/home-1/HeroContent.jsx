  ...
  return (
    <FadeUpAnimation className="relative z-10 grid grid-cols-12 items-center max-lg:gap-y-10">
      <div className="col-span-12 md:col-span-6">
        ...
        <form>
          <div className="border-borderColour dark:bg-dark-200 grid w-full max-w-[520px] grid-cols-12 items-center rounded-[60px] border bg-white pe-1 pt-1 pb-1 pl-4 sm:pl-5 dark:border-[#31332F]">
            <input
              type="text"
