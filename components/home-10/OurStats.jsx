  ...
  return (
    <section className="relative z-10 py-16 max-xl:px-5 md:pt-0 md:pb-[100px]">
      <FadeUpAnimation className="dark:bg-dark-200 rounded-medium shadow-nav container bg-white p-2.5">
        <div className="flex flex-col items-center justify-between gap-8 rounded border border-dashed border-gray-100 py-6 md:flex-row md:gap-0 dark:border-gray-600">
          <div className="flex flex-1 flex-col items-center space-y-6 border-dashed border-gray-400/25 py-6 md:border-r dark:border-gray-500/20">
