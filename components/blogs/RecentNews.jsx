...
const RecentNews = ({ blogItemData }) => {
  ...
  return (
    <section className="relative py-150 max-md:py-20">
      <div className="absolute top-20 left-1/2 -z-10 h-[550px] w-full -translate-x-1/2 bg-[url('/images/hero-gradient.png')] bg-cover bg-center bg-no-repeat opacity-70 md:hidden"></div>
      <div className="relative container mb-16">
        ...
        <div className="relative z-10">
          <div className="absolute top-60 left-1/2 -z-10 flex -translate-x-1/2 -translate-y-1/2 max-md:hidden max-md:flex-col">
