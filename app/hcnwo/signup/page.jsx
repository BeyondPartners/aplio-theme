            ...
            <div className="relative z-10 mx-auto max-w-[510px]">
              ...
              <div className="rounded-medium shadow-nav dark:bg-dark-200 bg-white p-2.5">
                <div className="dark:bg-dark-200 rounded border border-dashed border-gray-100 bg-white p-12 max-md:px-5 max-md:py-7 dark:border-gray-600">
                    ...
                    <div className="grid grid-cols-12 gap-y-6">
                      <div className="col-span-12">
                        ...
                        <input
                          ...
                          className="text-paragraph-light placeholder:text-paragraph-light focus:border-primary dark:bg-dark-200 dark:placeholder:text-paragraph-light dark:focus:border-primary block w-full rounded-[48px] border border-gray-200 bg-white px-5 py-2.5 text-sm outline-none dark:border-gray-600"
                        />
                      </div>
                      <div className="col-span-12">
                        <label
                        ...
                        <input
                          ...
                          className="text-paragraph-light placeholder:text-paragraph-light focus:border-primary dark:bg-dark-200 dark:placeholder:text-paragraph-light dark:focus:border-primary block w-full rounded-[48px] border border-gray-200 bg-white px-5 py-2.5 text-sm transition-all duration-300 outline-none dark:border-gray-600"
                        />
                      </div>
                      <div className="col-span-full">
                        ...
                        <input
                          ...
                          className="text-paragraph-light placeholder:text-paragraph-light focus:border-primary dark:bg-dark-200 dark:focus:border-primary block w-full rounded-[48px] border border-gray-200 bg-white px-5 py-2.5 text-sm transition-all duration-300 outline-none dark:border-gray-600"
                        />
                      </div>
                  ...
                  <div className="mb-8">
                    <button className="group font-jakarta-paragraph mb-6 flex w-full items-center justify-center gap-2 rounded-[30px] border border-gray-200 bg-white px-[30px] py-3.5 text-sm font-medium -tracking-[0.3px] max-md:px-5 dark:border-gray-600 dark:bg-transparent dark:text-white">
                    ...
                    <button className="group font-jakarta-paragraph flex w-full items-center justify-center gap-2 rounded-[30px] border border-gray-200 bg-white px-[30px] py-3.5 text-sm font-medium -tracking-[0.3px] max-md:px-5 dark:border-gray-600 dark:bg-transparent dark:text-white">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
